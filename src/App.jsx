		...
		<BrowserRouter>
			<div>
				<Routes>
					...
					<Route path='/write' element={<WritePostWindow write={write} setWrite={setWrite} />} />
					<Route path='/detail/:id' element={<DetailPage write={write} setWrite={setWrite}></DetailPage>} />
				</Routes>
			</div>
		</BrowserRouter>
	);
	...
	return (
		<nav className='window'>
			...
			<section className='window-body main-window-item2'>
				<div>
					<img src={profileImage} alt='프로필 사진' style={{ width: '70px', height: '70px', borderRadius: '50%' }} />
				</div>
				<div>
					<button>🔔</button>
					<button>🔎</button>
			...
			<div style={{ display: 'flex', gap: '20px' }}>
				<section className='window' style={{ width: '200px', height: '500px', flexShrink: 0 }}>
